...
- If you're not careful, CSS wrapped in JS\*
...
- Mostly used for transforming new modern JS (ES201X) features and JSX into well supported JS
...
- `css-loader`
  - Able to parse CSS and includes it into your JS bundle
  - Treats relative CSS paths within `@import` and `url()` as ES `import`s
- `style-loader` adds code that injects CSS into a `style` element at runtime
...
- Plugins intercept _runtime events_ at different stages of the bundling process
...
### Refining our CSS builds with `mini-css-extract-plugin`
...
1. Use `mini-css-extract-plugin` to emit a CSS file
2. Use `html-webpack-plugin` and the existing `src/index.html` as a `template`

You should end up with 3 files in your `dist/` folder: `app.js`, `index.html`, and `main.css`
...
- [_Survive JS - Webpack_ book](https://survivejs.com/webpack/)
- [HTML Webpack Plugin](https://webpack.js.org/plugins/html-webpack-plugin/)
- [Mini CSS Extract Webpack Plugin](https://webpack.js.org/plugins/mini-css-extract-plugin/)
